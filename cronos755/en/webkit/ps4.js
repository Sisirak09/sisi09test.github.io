...
function setupRW() {
	...
	if(localStorage.autoExploit=="true")
		debug_log("Webkit Runs with <font color=\"#00FF12\">SUCCESS !!</font>, Running Jailbreak and <font color=\"#F3D400\">GOLDHEN</font> ... <font color =\"#F00\"> WAIT!!!</font>");
	else
		debug_log("Webkit Runs with <font color=\"#00FF12\">SUCCESS !!</font>, Now Run the Jailbreak ...");
...
function toggle_payload(pld){
	if(pld == "exploit"){
		document.getElementById("progress").innerHTML="Performing the Jailbreak... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['jb/jb.js']);
	}else if(pld == "exploit_old"){
		document.getElementById("progress").innerHTML="Performing the Jailbreak... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['jb/oldjb.js']);
	}else if(pld == "binloader"){
		document.getElementById("progress").innerHTML="Waiting to send the .BIN file to port 9021.";
		preloadScripts(['payloads/preloader.js', 'payloads/loader.js']);
	}else if(pld == "mira75X"){
		document.getElementById("progress").innerHTML="Loading <font color=\"#001EFF\">MIRA</font>... <font color=\"#F00\">WAIT!!!</font>";
		if(fw=="755"){
		...
		document.getElementById("progress").innerHTML="Loading <font color=\"#001EFF\">MIRA-B</font> with <font color=\"#FF7E00\">SPOOFER</font>... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/mira2b.js', 'payloads/loader.js']);
	}else if(pld == "ftp"){
		setTimeout(function(){document.getElementById("progress").innerHTML="Starting FTP, Access through port 1337."; }, 7000);
		preloadScripts(['payloads/preloader.js', 'payloads/ftp.js', 'payloads/loader.js']);
	}else if(pld == "app2usb"){
		document.getElementById("progress").innerHTML="Loading APP-TO-USB... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/app2usb.js', 'payloads/loader.js']);
	}else if(pld == "disableupdates"){
		document.getElementById("progress").innerHTML="Disabling Updates... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/disableupdates.js', 'payloads/loader.js']);
	}else if(pld == "enableupdates"){
		document.getElementById("progress").innerHTML="Enabling Updates... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/enableupdates.js', 'payloads/loader.js']);
	}else if(pld == "backup"){
		document.getElementById("progress").innerHTML="Starting PS4 Backup... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/backup.js', 'payloads/loader.js']);
	}else if(pld == "restore"){
		document.getElementById("progress").innerHTML="Restoring PS4 Backup... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/restore.js', 'payloads/loader.js']);
	}else if(pld == "rifrenamer"){
		document.getElementById("progress").innerHTML="Loading Rif-Renamer... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/rifrenamer.js', 'payloads/loader.js']);
	}else if(pld == "todex"){
		document.getElementById("progress").innerHTML="Loading TO-DEX... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/todex.js', 'payloads/loader.js']);
	}else if(pld == "dumper"){
		document.getElementById("progress").innerHTML="Starting Game Dumper... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/dumper.js', 'payloads/loader.js']);
	}else if(pld == "disableaslr"){
		document.getElementById("progress").innerHTML="Loading Disable ASLR... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/disableaslr.js', 'payloads/loader.js']);
	}else if(pld == "kerneldumper"){
		document.getElementById("progress").innerHTML="Starting the kernel dumper... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/kerneldumper.js', 'payloads/loader.js']);
	}else if(pld == "kernelclock"){
		document.getElementById("progress").innerHTML="Starting Clock Dumper... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/kernelclock.js', 'payloads/loader.js']);
	}else if(pld == "fancontrol"){
		document.getElementById("progress").innerHTML="Starting Control FAN... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/fancontrol.js', 'payloads/loader.js']);
	}else if(pld == "enablebrowser"){
		document.getElementById("progress").innerHTML="Enabling Historic Browser... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/enablebrowser.js', 'payloads/loader.js']);
	}else if(pld == "historyblocker"){
		document.getElementById("progress").innerHTML="Disabling Browser History... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/historyblocker.js', 'payloads/loader.js']);
	}else if(pld == "exitidu"){
		document.getElementById("progress").innerHTML="Starting EXIT-IDU... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/exitidu.js', 'payloads/loader.js']);
	}else if(pld == "ps4debug"){
		document.getElementById("progress").innerHTML="Starting PS4 Debug... <font color=\"#F00\">WAIT!!!</font>";
		preloadScripts(['payloads/preloader.js', 'payloads/ps4debug.js', 'payloads/loader.js']);
	}else if(pld == "goldhen"){
		document.getElementById("progress").innerHTML="Loading <font color=\"#F3D400\">GOLDHEN V1.0</font>... <font color=\"#F00\">WAIT!!!</font>";
		if(fw=="755"){
		...
		document.getElementById("progress").innerHTML="Loading WEB-RTE... <font color=\"#F00\">WAIT!!!</font>";
		...
		document.getElementById("progress").innerHTML="Loading LINUX 1GB... <font color=\"#F00\">WAIT!!!</font>";
